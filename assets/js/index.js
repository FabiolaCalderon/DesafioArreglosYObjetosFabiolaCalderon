...
function generarHTMLPropiedades(propiedades, containerId) {
...
/*con esto se llama a la funcion y se crean las tarjetas */
generarHTMLPropiedades(propiedades_alquiler, 'alquiler');
generarHTMLPropiedades(propiedades_venta, 'ventas');